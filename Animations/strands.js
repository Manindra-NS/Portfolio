...
const container = document.getElementById('strands-bg');

if (container) {
  // ADD THESE EXACT LINES HERE: Force the container to cover the full screen
...
`;
  ...
  function resize() {
    ...
    // CHANGE THESE TWO LINES: Use window dimensions instead of container dimensions
